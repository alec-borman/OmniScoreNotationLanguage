...
![alt text](https://img.shields.io/badge/spec-v1.1-blueviolet)
![alt text](https://img.shields.io/badge/logic-100%25-success)
...
The Guitar Engine (Tablature)

The Percussion Engine (Grid)

Piano & Polyphony

Vocal & Lyrical Syntax

Orchestral Logic

Complex Time & Tuplets

Flow Control (Repeats/Coda)
...
Validation: The parser sums the durations (0.25 + ...) to ensure they equal the Time Signature (1.0 for 4/4). If they don't, it throws a MeasureOverflowError or MeasureUnderflowWarning.

Diffing: You can diff the JSON logic even if the syntax changes.

Transport: This JSON can be sent to MIDI players, VexFlow renderers, or Audio Engines.
